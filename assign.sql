create table employees(E_id int,E_name varchar(20) not null,salary int,age int,gender varchar(20),D_O_J varchar(20),primary key(E_id));
INSERT INTO employees (E_id, e_name, salary, age, gender, D_O_J) VALUES
...
select * from employees where salary between 3000 and 4000 limit 5;
select salary from employees where not salary = 4000;
select E_name from employees where salary = 3000 or salary = 4000;
select E_name from employees where gender = "female";
delete from employees where E_id = 1100;
select * from employees where E_id = 1100;
update employees set age=30 where E_id = 1099;
select * from employees where E_id = 1099;
select count(E_id) from employees;
select sum(salary) from employees where gender = "female";
select * from employees where D_O_J like '_____01%';
select E_name from employees where E_name like 'j%';
select max(salary) from employees where E_name like 'j%';
select salary,count(*)
from employees
...
from employees
group by age ;
select E_name,E_id from employees where E_name like 'j%a';
select count(E_name) from employees where E_name like 'j%';
select count(E_name) from employees where E_name like '%a';
